...
\vspace*{1.0em}
\pause
\item Many others: \href{http://caffe.berkeleyvision.org}{Caffe}, \href{https://github.com/dmlc/mxnet}{MXNet}, \href{http://chainer.org}{Chainer}, \href{https://github.com/clab/cnn}{CNN} \tiny{(the other, other one)}
\pause
