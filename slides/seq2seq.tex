...
\begin{tiny}
\begin{itemize}
	\item \url{https://github.com/farizrahman4u/seq2seq} (Keras)
	\item \url{https://github.com/rsennrich/nematus} (Theano)
	\item \url{https://github.com/harvardnlp/seq2seq-attn} (Torch)
	\item \url{https://github.com/tensorflow/models/tree/master/textsum} (TensorFlow)
\end{itemize}
\end{tiny}
\end{block}
